...
export function MarocGallery({ className = '' }: { className?: string }) {
  ...
  return (
    <div className={className} aria-label="Photos Maroc 2026">
      {/* Photo Grid - Bento */}
          ...
          >
            ...
            >
              ...
              <div className="text-center mt-3 md:mt-4 px-4">
                <p className="text-white/80 text-xs md:text-sm mb-1">{marocPhotos[selectedIndex].alt}</p>
